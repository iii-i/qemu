                     ...
                     uint32_t type)
{
    ...
    case 114: /* CPACF_PRNO_TRNG */
        /*
         * Fill both operands with random bytes, but only a limited amount per
         * invocation. Report partial completion with cc 3, so that the guest
         * reissues the instruction, giving the CPU a chance to handle pending
         * interrupts instead of hanging on a large request.
         */
